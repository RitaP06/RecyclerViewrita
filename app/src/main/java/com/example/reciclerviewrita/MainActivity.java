package com.example.reciclerviewrita;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void isiData(){
        ...
        mahasiswaList.add(new Mahasiswa("Rita p","311710619","1234456789"));
        mahasiswaList.add(new Mahasiswa("Ricky H","311710269","987654321"));
        mahasiswaList.add(new Mahasiswa("Rianti k","311710319","9876548765"));
        mahasiswaList.add(new Mahasiswa("Uswatun","311710625","0987581234"));
    }
}
